...
#Locations
nighthawk = Location.create(theater_name: "Nighthawk", address: "136 Metropolitan Ave")

amc = Location.create(theater_name: "AMC Fresh Meadows 7", address: "190-02 Horace Harding Expy")

ipic = Location.create(theater_name: "Ipic Fulton Market", address: "11 Fulton St")
